export function About() {
  return (
    <div className='flex items-center justify-center'>
      <div className='flex w-[1140px] h-[552px] text-justify border-solid border-2 border-zinc-800 bg-secondBackground rounded mb-20'>
        <img src='/test.jpg' alt='profile' className='rounded m-10'></img>
        <div>
          <h2 className='mt-20 text-green font-archivo text-lg'>Quem sou</h2>
          <h1 className='mt-4 text-white font-archivo text-4xl font-semibold'>Gabriel Pacheco</h1>
